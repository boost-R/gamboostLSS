...
DirichletAlpha = function(k=k,
  ...
  # Loss function is the negative log-likelihood of Dirichlet distribution
  ...
  # Negative gradient is the first partial derivative of the NLL with respect to all distributional parameters
  ...
  Family(ngradient = ngradient, risk = risk, loss = loss, response =
           function(f) exp(f), offset = offset, name = paste0("Dirichlet Distribution: a",k,"(log link)"))
}

DirichletLSS  <- function(K,a1=NULL,a2=NULL,a3=NULL,a4=NULL,a5=NULL,a6=NULL,a7=NULL,a8=NULL,a9=NULL,
    ...
    eval(parse(text=paste0("Families(",paste(fam,sep=","),")")))
